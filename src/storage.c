...
static bool init_schema_internal(sqlite3 *db) {
  ...
  const char *pricing_schema =
      ...
      "KEY(source,model)"
      ");"
      "INSERT OR IGNORE INTO model_pricing(source, model, input_rate, cache_read_rate, cache_write_rate, output_rate) VALUES"
      "('claude', 'claude-opus-4-8', 15.00, 1.50, 18.75, 75.00),"
      "('claude', 'claude-sonnet-4-6', 3.00, 0.30, 3.75, 15.00),"
      "('claude', 'claude-sonnet-5', 3.00, 0.30, 3.75, 15.00),"
      "('claude', 'gpt-5.5', 2.50, 1.25, 2.50, 10.00),"
      "('claude', 'gpt-5.6-sol', 2.50, 1.25, 2.50, 10.00),"
      "('codex', 'gpt-5.5', 2.50, 1.25, 2.50, 10.00),"
      "('codex', 'gpt-5.6-sol', 2.50, 1.25, 2.50, 10.00),"
      "('claude', 'claude-3-5-sonnet-20241022', 3.00, 0.30, 3.75, 15.00),"
      "('claude', 'claude-3-7-sonnet', 3.00, 0.30, 3.75, 15.00),"
      "('claude', 'claude-3-opus-20240229', 15.00, 1.50, 18.75, 75.00),"
      "('claude', 'claude-3-5-haiku-20241022', 0.80, 0.08, 1.00, 4.00),"
      "('codex', 'gpt-4o', 2.50, 1.25, 2.50, 10.00),"
      "('codex', 'gpt-4o-mini', 0.15, 0.075, 0.15, 0.60),"
      "('codex', 'o1', 15.00, 7.50, 15.00, 60.00),"
      "('codex', 'o3-mini', 1.10, 0.55, 1.10, 4.40);";
